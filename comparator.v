...
// /___/   /\     Timestamp : 01/30/2025 23:33:47
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/EE533_Lab3/mini_IDS_V5/comparator.sch" comparator.vf
...
module comparator(a, 
   ...
   COMP8_MXILINX_comparator XLXI_4 (.A(a[23:16]), 
                                    .B(b[23:16]), 
                                    .EQ(XLXN_28));
   // synthesis attribute HU_SET of XLXI_4 is "XLXI_4_0"
   COMP8_MXILINX_comparator XLXI_5 (.A(a[15:8]), 
                                    .B(b[15:8]), 
                                    .EQ(XLXN_27));
   // synthesis attribute HU_SET of XLXI_5 is "XLXI_5_1"
   COMP8_MXILINX_comparator XLXI_6 (.A(a[7:0]), 
                                    .B(b[7:0]), 
                                    .EQ(XLXN_26));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_2"
   AND7_MXILINX_comparator XLXI_7 (.I0(XLXN_36), 
                                   .I1(XLXN_35), 
                                   .I2(XLXN_34), 
                                   .I3(XLXN_33), 
                                   .I4(XLXN_32), 
