...
// /___/   /\     Timestamp : 01/30/2025 22:18:29
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/EE533_Lab3/mini_IDS_V4/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   synch_dp_mem XLXI_1 (.addra(XLXN_35[7:0]), 
                        .addrb(XLXN_38[7:0]), 
                        .clka(clk), 
                        .clkb(clk), 
                        .dina(XLXN_1[71:0]), 
   ...
   COMP8_MXILINX_dropfifo XLXI_7 (.A(XLXN_35[7:0]), 
                                  .B(XLXN_38[7:0]), 
                                  .EQ(XLXN_40));
   // synthesis attribute HU_SET of XLXI_7 is "XLXI_7_18"
   COMP8_MXILINX_dropfifo XLXI_8 (.A(XLXN_38[7:0]), 
                                  .B(XLXN_30[7:0]), 
                                  .EQ(XLXN_39));
   ...
   reg9B XLXI_12 (.ce(XLXN_3), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_1[71:0]));
   AND3B2 XLXI_13 (.I0(XLXN_39), 
                   .I1(XLXN_40), 
                   .I2(fiforead), 
                   .O(XLXN_42));
   OR2 XLXI_14 (.I0(XLXN_59), 
                .I1(XLXN_60), 
                .O(XLXN_10));
   AND2B1 XLXI_15 (.I0(XLXN_29), 
                   .I1(XLXN_10), 
                   .O(XLXN_33));
   VCC XLXI_16 (.P(XLXN_3));
endmodule
